function [nu_deg, fe] = aaf_importarEclipses(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ECLIPSESLN1200 = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   ECLIPSESLN1200 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   EclipsesLN1200 = importfile('EclipsesLN1200.txt', 4, 1003);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/02/24 20:35:13
