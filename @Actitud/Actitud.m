classdef Actitud
    ...
    methods(Static=false)
        ...
        function obj = rotacionPorCuaternion(obj, q)
            ...
            obj.x_b = Actitud().quat_rota(q, obj.x_b);
            obj.y_b = Actitud().quat_rota(q, obj.y_b);
            obj.z_b = Actitud().quat_rota(q, obj.z_b);
        endfunction
        function obj = rotacionPorEuler(obj, precesion, nutacion, rotacion)
            %rotacionPorAngulosEuler Giro con angulos de Tait-Bryan
            q = obj.cuaternionRotacionEuler(precesion, nutacion, rotacion);
